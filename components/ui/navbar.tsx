...
export default function Navbar() {
    ...
    return (
        <>
            ...
            >
                <div onClick={handleMenuClick} className="w-fit text-4xl ml-auto mr-8 mt-3.5">
                    <IoMenu />
                </div>

                <div onClick={handleMenuClick} className="flex h-fit w-fit flex-col justify-around p-5 gap-y-6">
